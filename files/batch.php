  ...
  <body style="background-image: url('hello.jpg');background-size: cover;">
    ...
    <div class="row" >
        ...
        <div class="col-lg-3 z" >
          <a href="add_batch.php"> <center><img src="batchadd.png" height="150" width="150" ></center> </a>
          <h4 style="text-align:center; ">ADD BATCH</h4>
        </div>
        <div class="col-lg-3 z" >
          <a href="delete_batch.php"> <center><img src="batchtrash.png" height="150" width="150"> </center></a>
          <h4 style="text-align:center; ">DELETE BATCH</h4>
        </div>
        <div class="col-lg-3 z" >
          <a href="view_batches.php"> <center><img src="batchsearch.png" height="150" width="150"> </center></a>
