...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($countBranch==1){
        $delBranch=mysqli_multi_query($link,"DELETE FROM branch WHERE branch_code='$bcode';DELETE FROM student WHERE branch_code='$bcode';DELETE FROM teacher WHERE branch_code='$bcode';DELETE FROM subject WHERE branch_code='$bcode';DELETE FROM marks WHERE branch='$bcode';");
        echo "<script>
